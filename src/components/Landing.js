                    ...
                    <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                        ...
                        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                            <div>
                                ...
                                <h3 className="mb-2 text-2xl font-bold dark:text-white">Pre-book your charging slot</h3>
                                <p className="font-light text-gray-500 dark:text-gray-400">Don't waste the time, utilize it.</p>
                            </div>
                            <div>
                                ...
                                <h3 className="mb-2 text-2xl font-bold dark:text-white">Rental Service</h3>
                                <p className="font-light text-gray-500 dark:text-gray-400">Wanna go to trip contact our agencies.</p>
                            </div>
                            <div>
                                ...
                                <h3 className="mb-2 text-2xl font-bold dark:text-white">Mechanics Support</h3>
                                <p className="font-light text-gray-500 dark:text-gray-400">Contact our trusted mechanics.</p>
                            </div>
                            <div>
                                ...
                                <h3 className="mb-2 text-2xl font-bold dark:text-white">Near by cafe & stores</h3>
                                <p className="font-light text-gray-500 dark:text-gray-400">Enjoy the time while your car is being charged.</p>
                            </div>
                        </div>
                    </div>
                </section>
